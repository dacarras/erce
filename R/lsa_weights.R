...
#'
#' @return the original data frame with the new weights at the end, where `wa1` and `wa2` are level 1 and level 2 normalized weights; `wb1` and `wb2` are level 1 and level 2 effectives sample weights.
#'
