#' ERCE 2019 Prueba de lenguaje de tercer grado
#'
...
#'
#' La presente base de datos incluye respuestas corregidas a los items de la prueba de Lenguaje.
#'
#' @docType data
#'
#' @usage data(erce_2019_pl3)
#'
...
#' @examples
#' data(erce_2019_pl3)
#' labelled::look_for(erce_2019_pl3) # mostrar variables
"erce_2019_pl3"
