#' ERCE 2019 Familias de Estudiantes de Tercer Grado
#'
...
#'
#' La presente base de datos incluye las respuestas de las familias
#' al cuestionario de familias, de los estudiantes de Tercer Grado.
#'
#' @docType data
#'
#' @usage data(erce_2019_qf3)
#'
...
#' @examples
#' data(erce_2019_qf3)
#' labelled::look_for(erce_2019_qf3) # mostrar variables
"erce_2019_qf3"
